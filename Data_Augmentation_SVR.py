...
for i in tqdm(range(len(sensor_list_la))):
    ...
    ### Training SVR without Augmentation ###
    ...
    regr = make_pipeline(StandardScaler(), MultiOutputRegressor(LinearSVR(max_iter=5000)))
    ...
    ### Training SVR with Augmentation ###
...
result_df.to_csv("../Results/SVR_performance_table.csv")
